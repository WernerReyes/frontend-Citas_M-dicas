...
const editProfileDashboardMedicalPage = async(container) => {
    ...
    try {
        ...
        const editProfile = editProfileSection(doctor, 'doctors');
...
export default editProfileDashboardMedicalPage;