...
import { manageScheduleSection, sidebarAdministator } from "../../../components/private";
import { verifyTokenUtil } from "../../../utils/verifyToken";

const manageSchedulesDashboardAdministratorPage = async (container) => {
    container.className = 'container-fluid overflow-hidden';
    if (document.getElementById('main-manage-schedules')) return;
    try {
        ...
        main.id = 'main-manage-schedules';
        main.classList.add('col-9', 'col-sm-8', 'col-md-10');

        const manage = await manageScheduleSection();
        ...
        const modal = modalBase('schedule-modal');
...
export default manageSchedulesDashboardAdministratorPage;