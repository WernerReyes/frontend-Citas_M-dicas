...
import { profileInformationSection, sidebarAdministator } from "../../../components/private";
...
const profileDashboardAdministratorPage = async(container) => {
    ...
    try {
        ...
        const profile = profileInformationSection(administrator);
        const editProfileButton = profile.querySelector('#editar-perfil');
        editProfileButton.href = URLS_APP.EDIT_PROFILE_DASHBOARD_ADMINISTRATOR;   
