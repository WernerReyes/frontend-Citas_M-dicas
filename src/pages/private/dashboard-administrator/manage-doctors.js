...
import { manageDoctorSection, sidebarAdministator } from "../../../components/private";
import { verifyTokenUtil } from "../../../utils/verifyToken";

const manageDoctorsDashboardAdministratorPage = async(container) => {
    container.className = 'container-fluid overflow-hidden';
    if (document.getElementById('main-manage-doctors')) return;
    try {
        ...
        main.id = 'main-manage-doctors';
        main.classList.add('col-9', 'col-sm-8', 'col-md-10');

        const manage = await manageDoctorSection();
...
export default manageDoctorsDashboardAdministratorPage;